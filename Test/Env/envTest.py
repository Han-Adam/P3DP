...
class EnvTest:
    ...
    def reset(self, initial_condition=None, strategy_num=None, train=False):
        self.train = train
    ...
    def _state_reward(self, red_done, blue_done):
        ...
        angle_relation2_red = np.array([-pitch_d, hca, np.pi-aa, np.pi-ata])
